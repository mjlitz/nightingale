...
exceptions = """
a-round as-so-ciate as-so-ciates dec-li-na-tion eve-ry oblig-a-tory on-ly phil-an-thropic pre-sent
pre-sents pro-ject pro-jects reci-procity re-cog-ni-zance ref-or-ma-tion
ret-ri-bu-tion ta-ble stran-ger gon-na stran-gers
"""#i added strang-ers
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        for word in sys.argv[1:]:
            print('-'.join(hyphenate_word(word)))#I edited this line to make it python3 compatible
    else:
        import doctest
